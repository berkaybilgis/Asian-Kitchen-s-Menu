...
document.getElementById("All").addEventListener("click", allScript)
...
document.getElementById("Korea").addEventListener("click", koreaScript)

function koreaScript() {
  let korean = menu.filter((item) => item.category === "Korea");
  section.innerHTML = "";
  createMenuItems(korean);
}

document.getElementById("Japan").addEventListener("click", japanScript)

function japanScript() {
  let japan = menu.filter((item) => item.category === "Japan");
  section.innerHTML = "";
  createMenuItems(japan);
}

document.getElementById("China").addEventListener("click", chinaScript)

function chinaScript() {
